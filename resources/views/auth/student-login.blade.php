...
<div class="flex items-center justify-center min-h-screen px-4 py-12 bg-gray-50">
    <div class="w-full max-w-md space-y-8">
        <div class="text-center">
            ...
            <h2 class="text-3xl font-bold text-gray-900">بوابة الطلبة</h2>
            <p class="mt-2 text-sm text-gray-600">يرجى إدخال بياناتك للدخول إلى حسابك الطلابي</p>
        </div>

        <form class="mt-8 space-y-6" action="{{ route('login.student') }}" method="POST">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input id="password" name="password" type="password" required
                        ...
                        placeholder="رقم طلب الانتساب">
                    <p class="mt-1.5 text-xs text-gray-400">كلمة المرور هي رقم طلب الانتساب (4 أرقام)</p>
                </div>
            </div>
