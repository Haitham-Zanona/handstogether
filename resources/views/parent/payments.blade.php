...
$pageDescription = 'عرض الدفعات والمستحقات المالية';
@endphp
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-4 py-3 text-sm font-medium text-gray-900">{{ $payment->student?->user?->name ?? '—' }}</td>
                    ...
                    <td class="px-4 py-3 text-sm text-gray-600">
                        ...
                        @endphp
                        {{ $typeLabels[$payment->type ?? 'monthly'] ?? 'شهري' }}
                    </td>
                    <td class="px-4 py-3">
                ...
                @empty
                <tr>
                    <td colspan="6" class="px-4 py-12 text-center text-gray-400">لا توجد دفعات مسجلة</td>
                </tr>
                @endforelse
            </tbody>
        </table>
